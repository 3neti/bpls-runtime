        ...
        try {
            ...
            if (in_array($phase, ['prepare', 'all'], true)) {
                ...
                $manifest = match ($scenario->key) {
                    ...
                    'citizen_new_permit_lifecycle_authority_boundary', 'nelson_walkthrough', 'new_permit_lifecycle_authority_boundary' => $manualCollectionReceiptScenario->prepare($scenario, $runId, $actors, $artifactStore),
            ...
            if (in_array($phase, ['audit', 'all'], true)) {
                $manifest = match ($scenario->key) {
                    ...
                    'citizen_new_permit_lifecycle_authority_boundary', 'nelson_walkthrough', 'new_permit_lifecycle_authority_boundary' => $manualCollectionReceiptScenario->audit($manifest ?? $this->requireManifest($artifactStore), $artifactStore),
