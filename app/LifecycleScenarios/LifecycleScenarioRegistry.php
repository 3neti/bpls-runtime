...
final class LifecycleScenarioRegistry
{
    ...
    {
        return [
            'stakeholder_preview_cycle_1' => new LifecycleScenarioDefinition(
                key: 'stakeholder_preview_cycle_1',
                label: 'Deterministic stakeholder preview composition',
                mode: 'stakeholder_preview_cycle_1',
                ...
                actors: [
                    ...
                    'mpdo' => 'preview_mpdo',
                    'assessor' => 'preview_assessor',
                    'health' => 'preview_health',
                    'menro' => 'preview_menro',
                    'mayor_office' => 'preview_mayor_office',
                    'releasing' => 'preview_releasing',
                ],
                safety: [
                ...
                expectations: [
                    ...
                    'qr_golden_payment_schedule_status' => 'pending',
                    'qr_golden_positive_unpaid_count' => 1,
                    'qr_golden_collection_count' => 0,
                    ...
                    'office_charge_contributions' => 5,
                    'provisional_uat_permit_status' => 'released_in_preview',
                    'production_permit_authority' => false,
            ...
            'revenue_code_fee_catalog_visibility' => new LifecycleScenarioDefinition(
                ...
                expectations: [
                    ...
                    'provision_count' => 108,
                    'reconciliation_required_count' => 107,
