...
final class ManualCollectionReceiptVisibilityScenario
{
    ...
    public function audit(array $manifest, ScenarioArtifactStore $artifactStore): array
    {
        ...
        $checks = [
            ...
            $this->step('audit-authority-boundary', 'Authority boundary separates software evidence from human issuance authority', ['status' => 'ready_for_authority_review', 'artifact_statement' => 'The generated permit document supports municipal review but does not issue or release a permit and has no legal effect.'], ['status' => $releaseReadiness['authority_boundary']['status'], 'artifact_statement' => $releaseReadiness['authority_boundary']['artifact_statement']]),
