...
final class RevenueCodeFeeCatalogVisibilityScenario
{
    ...
    private const POLICY_BOUNDARY_PROVISION_CODES = [
        ...
        'MRC-3I-03-SANCTIONS',
        'MRC-3I-04-FEES',
        'MRC-3J-01-FILMING-FEES',
        'MRC-3J-02-PAYMENT-TIMING',
        'MRC-3K-01-ANNUAL-EQUIPMENT-FEES',
        'MRC-3K-02-PAYMENT-TIMING',
        'MRC-3K-03-EQUIPMENT-REGISTRY',
        'MRC-3K-04-PENALTY',
        'MRC-3L-01-SCOPE',
        'MRC-3L-02-DEFINITIONS',
        'MRC-3L-03-REGULATORY-BOARD',
        'MRC-3L-04-GRANTING-MTOP',
        'MRC-3L-05-FEES',
        'MRC-3L-06-APPROVAL-RENEWAL',
        'MRC-3L-07-MARKINGS',
        'MRC-3L-08-SUSPENSION-STOPPAGE',
        'MRC-3L-09-NONTRANSFERABILITY',
        'MRC-3L-10-DAY-OFF',
        'MRC-3L-11-FARE',
        'MRC-3L-12-ROTUNDA-RESTRICTION',
        'MRC-3L-13-ROUTES',
        'MRC-3L-14-HIGHWAY-LANE',
        'MRC-3L-15-ASSOCIATION',
        'MRC-3L-16-PROHIBITED-ACTS',
        'MRC-3L-17-APPREHENDING-OFFICERS',
        'MRC-3L-18-PENALTIES',
        'MRC-3L-19-FINE-DISPOSITION',
        'MRC-3L-20-REPEALING',
        'MRC-3L-21-SEPARABILITY',
        'MRC-3M-01-OCCUPATIONAL-FEES',
        'MRC-3M-02-EXEMPTIONS',
        'MRC-3M-03-PERSONS-GOVERNED',
        'MRC-3M-04-PAYMENT-TIMING',
        'MRC-3M-05-LATE-CHANGES-RENEWAL',
        'MRC-3M-06-ADMINISTRATION',
    ];
    ...
    public function prepare(LifecycleScenarioDefinition $scenario, string $runId, array $actors, ScenarioArtifactStore $artifactStore): array
    {
        ...
        $steps = [
            ...
            $this->step('provision-coverage-recorded', 'Verify provision coverage is distinct from executable policy', ['provision_count' => 108, 'reconciliation_required_count' => 107], ['provision_count' => RevenueCodeProvision::query()->count(), 'reconciliation_required_count' => RevenueCodeProvision::query()->where('reconciliation_status', 'reconciliation_required')->count()]),
            ...
            $this->step('policy-boundary-clauses-recorded', 'Record non-schedule legal clauses without authorizing financial execution', ['provision_count' => 106, 'clause_count' => 593, 'reconciliation_required_count' => 593, 'ceiling_count' => 5, 'execution_ready_count' => 0], $policyBoundarySummary),
        ];
