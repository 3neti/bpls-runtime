...
final class RenewalHappyPathDefinition
{
    public const string Id = 'renewal-happy-path';
    ...
    public const string EvidenceQuestion = 'Can a normal Renewal become an approved payable?';
    ...
    public function describe(): array
    {
        return [
            'id' => self::Id,
            'label' => 'Scenario 01 — Renewal Happy Path',
    ...
    public function linesOfBusiness(): array
    {
        return [
            [
                'code' => 'S01-RETAIL-TRADING',
                'name' => 'Scenario 01 Retail Trading',
            ...
            [
                'code' => 'S01-FOOD-SERVICE',
                'name' => 'Scenario 01 Food Service',
    ...
    {
        return [
            $this->responsibility('retail.business-tax.charge', 'assessor', 'S01-RETAIL-TRADING', 'S01-RETAIL-BUSINESS-TAX', 'Business Tax', 24_000, false, 'Assessor reviews the declared gross-receipts basis for the Retail Trading LOB.'),
            $this->responsibility('retail.mayors-permit.charge', 'engineering', 'S01-RETAIL-TRADING', 'S01-RETAIL-MAYORS-PERMIT', "Mayor's Permit Fee", 9_000, true, 'Engineering reviews the Retail premises for provisional permit-fee applicability.'),
            $this->responsibility('food.business-tax.charge', 'assessor', 'S01-FOOD-SERVICE', 'S01-FOOD-BUSINESS-TAX', 'Business Tax', 31_000, false, 'Assessor reviews the declared gross-receipts basis for the Food Service LOB.'),
            $this->responsibility('food.health-certificate.charge', 'health', 'S01-FOOD-SERVICE', 'S01-FOOD-HEALTH-CERTIFICATE', 'Health Certificate', 9_500, true, 'Health reviews Food Service operations for provisional Health Certificate applicability.'),
            $this->responsibility('food.sanitary-permit.charge', 'health', 'S01-FOOD-SERVICE', 'S01-FOOD-SANITARY-PERMIT', 'Sanitary Permit Fee', 6_500, true, 'Health reviews Food Service sanitation for provisional Sanitary Permit applicability.'),
            $this->responsibility('food.solid-waste.charge', 'menro', 'S01-FOOD-SERVICE', 'S01-FOOD-SOLID-WASTE', 'Solid Waste Management', 7_000, true, 'MENRO reviews the provisionally waste-producing Food Service activity.'),
        ];
    }
