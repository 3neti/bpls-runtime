...
final class RenewalHappyPathDefinition
{
    ...
    public const string EffectiveDate = '2026-01-15';
    ...
    public function describe(): array
    {
        return [
            'id' => self::Id,
            'label' => 'Scenario 02 — Renewal Happy Path',
    ...
    {
        return [
            $this->responsibility('retail.business-tax.charge', 'assessor', 'PRODUCT-LAB-RETAIL-TRADING', 'S02-RETAIL-BUSINESS-TAX', 'Business Tax', 24_000, false, 'Assessor reviews the declared gross-receipts basis for the Retail Trading LOB.'),
            $this->responsibility('retail.mayors-permit.charge', 'engineering', 'PRODUCT-LAB-RETAIL-TRADING', 'S02-RETAIL-MAYORS-PERMIT', "Mayor's Permit Fee", 9_000, true, 'Engineering reviews the Retail premises for provisional permit-fee applicability.'),
            $this->responsibility('food.business-tax.charge', 'assessor', 'PRODUCT-LAB-FOOD-SERVICE', 'S02-FOOD-BUSINESS-TAX', 'Business Tax', 31_000, false, 'Assessor reviews the declared gross-receipts basis for the Food Service LOB.'),
            $this->responsibility('food.health-certificate.charge', 'health', 'PRODUCT-LAB-FOOD-SERVICE', 'S02-FOOD-HEALTH-CERTIFICATE', 'Health Certificate', 9_500, true, 'Health reviews Food Service operations for provisional Health Certificate applicability.'),
            $this->responsibility('food.sanitary-permit.charge', 'health', 'PRODUCT-LAB-FOOD-SERVICE', 'S02-FOOD-SANITARY-PERMIT', 'Sanitary Permit Fee', 6_500, true, 'Health reviews Food Service sanitation for provisional Sanitary Permit applicability.'),
            $this->responsibility('food.solid-waste.charge', 'menro', 'PRODUCT-LAB-FOOD-SERVICE', 'S02-FOOD-SOLID-WASTE', 'Solid Waste Management', 7_000, true, 'MENRO reviews the provisionally waste-producing Food Service activity.'),
        ];
    }
