 ...
 */
#[Fillable(['legacy_permit_evidence_plan_id', 'legacy_record_id', 'legacy_clearance_type_reconciliation_id', 'source_dataset', 'kind', 'item_key', 'status', 'projection_hash', 'reasons', 'metadata'])]
