...
class LegacyImportBatch extends Model
{
    ...
    public function historicalFinancialPreservationPlans(): HasMany
    {
        return $this->hasMany(LegacyHistoricalFinancialPreservationPlan::class, 'legacy_import_batch_id');
    }
