...
use Database\Factories\LegacyApplicationMappingExecutionFactory;
 ...
 */
#[Fillable(['legacy_application_mapping_plan_id', 'run_reference', 'selection_hash', 'status', 'selected_count', 'created_count', 'linked_count', 'reused_count', 'mapping_count', 'started_at', 'completed_at', 'rolled_back_at', 'metadata'])]
class LegacyApplicationMappingExecution extends Model
{
    /** @use HasFactory<LegacyApplicationMappingExecutionFactory> */
    use HasFactory;
    ...
    /** @return HasMany<LegacyApplicationIdMapping, $this> */
    public function mappings(): HasMany
    {
        return $this->hasMany(LegacyApplicationIdMapping::class);
    }
