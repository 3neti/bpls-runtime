...
use Database\Factories\LegacyPermitEvidencePlanFactory;
...
class LegacyPermitEvidencePlan extends Model
{
    /** @use HasFactory<LegacyPermitEvidencePlanFactory> */
    use HasFactory;
    ...
    /** @return HasMany<LegacyPermitEvidenceProposal, $this> */
