...
use Database\Factories\LegacyApplicationMappingPlanFactory;
 ...
 */
#[Fillable(['legacy_import_batch_id', 'run_reference', 'planner_version', 'dependency_snapshot_hash', 'status', 'proposal_count', 'ready_count', 'review_count', 'blocked_count', 'exact_link_count', 'started_at', 'completed_at', 'metadata'])]
class LegacyApplicationMappingPlan extends Model
{
    /** @use HasFactory<LegacyApplicationMappingPlanFactory> */
    use HasFactory;
    ...
    /** @return HasMany<LegacyApplicationMappingProposal, $this> */
