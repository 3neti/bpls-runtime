...
use Database\Factories\LegacyPermitEvidenceExecutionFactory;
 ...
 */
#[Fillable(['legacy_permit_evidence_plan_id', 'run_reference', 'selection_hash', 'status', 'selected_count', 'created_count', 'linked_count', 'reused_count', 'mapping_count', 'started_at', 'completed_at', 'rolled_back_at', 'metadata'])]
class LegacyPermitEvidenceExecution extends Model
{
    /** @use HasFactory<LegacyPermitEvidenceExecutionFactory> */
    use HasFactory;
