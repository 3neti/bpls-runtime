    ...
    public function handle(PermitApplication $permitApplication): array
    {
        ...
        if (is_array($releaseBoundary)) {
            ...
            $events->push($this->event(
                ...
                description: 'Municipal release is not confirmed. The responsible authority, official signatories, and public verification still require municipal confirmation.',
                status: 'needs_municipal_confirmation',
                actor: $this->actor($actorId === null ? null : $metadataActors->get($actorId)),
