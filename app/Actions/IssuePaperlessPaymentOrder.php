        ...
        return DB::transaction(function () use ($item, $revision, $issuingActor): PaperlessPaymentOrder {
            ...
            $order = $application->paperlessPaymentOrders()->create([
                ...
                'source_snapshot' => [
                    ...
                    'scheduled_amount_minor' => data_get($revision->value, 'determination.scheduled_amount_minor'),
                    'determined_amount_minor' => data_get($revision->value, 'determination.determined_amount_minor', $amountCents),
                    'variance_minor' => data_get($revision->value, 'determination.variance_minor'),
