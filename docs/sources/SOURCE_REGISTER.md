...
| LIVE-APP-001 | Currently deployed BPLS Portal | Observed production behavior | URL and authorized account supplied by project owner on 2026-08-13; credentials intentionally not recorded | Verified 2026-08-13 | `https://www.ipil-bpls.online/dashboard` | Browser login verified to non-login URL `https://www.ipil-bpls.online/dashboard`; title observed: `BPLS Portal` | Not applicable | Access verified | Production is read-mostly evidence. Observed navigation includes dashboard, permit applications, permits, business owners, business information, payments and billing, billing groups, reports, clearances, activity, user management, taxes and fees. |
