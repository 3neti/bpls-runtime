...
Additive read-only run `prod-human-identity-frontier-20260818-012` uses characterization schema `bpls.historical-financial-human-identity-frontier.v8`. It reproduces every canonical v4-v7 fingerprint exactly, then binds deterministic exception evidence under SHA-256 `7ffd413d22ded6a34e70d8afd1e75b435ffa27c398758de44e9b5939e9af5913` and the campaign-readiness census under SHA-256 `2002093df24e610c31cd3432ab34a34df6385cfd1098e3c049400fd3be0c7f46`.

The corrected V1 estate now reproduces as an exact disjoint campaign partition: 407 applications with exact mappings and reversible execution/rollback evidence; 736 human-identity decision cases; 72 registry-policy-only cases; and eight residual exceptions comprising five soft-deleted Treasury/reference cases plus three financial-override/`Released`/reference cases. All six pairwise overlaps are zero and the union is exactly 1,223 applications. The original frozen census remains 1,238 because 15 histories with application-level unassigned payment events stay outside V1. The nine human-frontier exception histories are nested overlays, not additional applications.

The exact 407-member campaign candidate is bound to SHA-256 `76e9c985a2c5a3fb961924d4ed6e829956b2503c56dbe959db367cebeafdf0dd`. It reproduces 696 schedules, 3,007 fee lines, 660 completed payments, 36 unpaid schedules, 412,770,810 scheduled centavos, 397,445,008 paid centavos, 407 live exact mappings and Ready preservation proposals, nine rolled-back executions, and zero remaining preserved bundles. V8 does not independently revalidate the separately retained source-to-target or restoration audits; those canonical audit artifacts must be bound to this exact membership before a campaign freeze or production-authorization decision.

For the eight soft-deleted histories and the identity-plus-financial exception, V8 preserves exact source lifecycle and deletion markers, source owner/business edges, persisted historical-financial totals, resolvable location hierarchies, and exact legacy declaration-to-group lookup behavior. These facts do not normalize deletion, reactivate a record, establish legal identity or target reference identity, choose a side of the draft/submission contradiction, infer fee policy, accept authority, or authorize rehearsal or production.
