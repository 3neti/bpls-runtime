...
The Nelson Visual Walkthrough and UI/UX Cycle 1 remain frozen evidence baselines. Nelson's 2026-08-19 follow-up resolves only the pre-payment assessment approval stage: Assessment Officer preparation and Municipal Treasurer approval/return are distinct authoritative facts, and matching approval permits payment scheduling. `OPERATIONAL-NELSON-001`, registered on 2026-08-20, is consistent with that bounded approval but exposes pre-assessment Paperless Payment Orders, step-specific documents, named post-payment clearances, a second post-clearance approval, a Business Permit Portal push, and one-transaction payment evidence. Revenue Code installment provisions and unresolved municipal authority block automatic implementation. The deployed approval-stage UAT remains historical evidence; semantic freeze and Warp Product/UI Critic review are paused. Use `docs/agents/NELSON_FEEDBACK_INTAKE.md` for additive feedback and `docs/agents/LEGACY_VISUAL_PARITY_COMPARISON.md` to compare separately proven legacy and Laravel visual evidence.
...
- Additive v6 decision-unlock characterization preserves every v5 fingerprint while separating complete review units from partial views of wider source collisions. The 51 `name_birth` groups comprise 14 closed groups covering 28 applications and 37 externally coupled groups covering 41 cohort applications plus 52 owner proposals outside the cohort. The 52 registration groups comprise 18 closed groups covering 39 applications and 34 externally coupled groups covering 36 cohort applications plus 37 business proposals outside the cohort.
- An authoritative disposition covering every member of a closed group can unlock exact proposal preparation for that identity dimension. Externally coupled groups require review of their full global membership. Neither outcome accepts a mapping, resolves another blocker dimension, activates historical status, or authorizes rehearsal.
- The eight soft-deleted applications now reproduce as five disjoint decision routes: three deletion/identity/reference-only, two Treasury, one fiscal-authority, one permit-authority, and one source-contradiction application. Every route still requires deletion, identity, reference-data, mapping, freeze, and rehearsal gates as applicable. The one identity-plus-financial exception requires independent identity and fiscal decisions and full global owner-collision-group review.
- Additive v7 registration routing preserves every v6 fingerprint while partitioning the 52 registration groups into 49 single-owner-evidence-lane groups and three closed mixed-lane groups. Contact-only routes contain seven closed / 14 applications and 16 coupled / 17 applications plus 18 outside business proposals. Non-contact-only routes contain eight closed / 17 applications and 18 coupled / 19 applications plus 19 outside proposals. The three mixed closed groups cover eight applications; no coupled group is mixed. Registration decision-route SHA-256 is `f64c014c67354ed0700e54ad06d069dd6fbb5ba2d8a311a059f8322932359e57`.
- Additive v8 deterministic-exception and campaign-readiness characterization preserves every v4-v7 fingerprint. The corrected V1 estate is now an exact disjoint partition of 407 reversible execution/rollback cases, 736 human-identity decision cases, 72 registry-policy-only cases, and eight residual exceptions; all six pairwise overlaps are zero. Fifteen structural exceptions remain outside V1, so the original frozen census remains 1,238. The exact 407-member campaign candidate is bound to SHA-256 `76e9c985a2c5a3fb961924d4ed6e829956b2503c56dbe959db367cebeafdf0dd`; campaign-readiness SHA-256 is `2002093df24e610c31cd3432ab34a34df6385cfd1098e3c049400fd3be0c7f46`.
- V8 preserves exact historical financial, lifecycle/deletion, source-edge, location-hierarchy, and legacy declaration lookup facts for the eight soft-deleted histories and one identity-plus-financial exception without normalizing deletion, reactivating records, inferring identity or fee policy, choosing contradictory source truth, or accepting any authority. The nine exception histories remain nested overlays inside the 736, not additional migration units.
- The 407-member class is sufficiently bounded to propose a first controlled production campaign, but not to execute one. Campaign freeze still requires binding the canonical source-to-target and restoration audits to the exact membership. Production authorization must name the cohort fingerprint, authority, execution window, rollback/abort thresholds, and mandatory post-run audit.
