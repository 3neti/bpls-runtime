...
evidence_root="${repository_root}/storage/app/private/bpls-installation/product-lab-baseline-certification"
...
run_artisan_postgres "${postgres_persistent_database}" php artisan bpls:lifecycle:run renewal-happy-path --persist --json >"${evidence_root}/persistent-postgresql-first.json"
run_artisan_postgres "${postgres_persistent_database}" php artisan bpls:lifecycle:run renewal-happy-path --persist --json >"${evidence_root}/persistent-postgresql-rerun.json"
