...
evidence_root="${repository_root}/storage/app/private/lifecycle-scenarios/renewal-happy-path/first-principles-certification"
...
run_artisan_sqlite() {
    DB_CONNECTION=sqlite DB_DATABASE="${sqlite_database}" "$@"
}
...
run_artisan_sqlite php artisan db:seed --class=RevenueCodeFeeCatalogSeeder --force --no-interaction >/dev/null
run_artisan_sqlite php artisan bpls:lifecycle:run renewal-happy-path --json >"${evidence_root}/fresh-sqlite.json"
run_artisan_sqlite php artisan bpls:lifecycle:run renewal-happy-path >"${evidence_root}/fresh-sqlite-cli.txt"
...
run_artisan_postgres "${postgres_fresh_database}" php artisan db:seed --class=RevenueCodeFeeCatalogSeeder --force --no-interaction >/dev/null
run_artisan_postgres "${postgres_fresh_database}" php artisan bpls:lifecycle:run renewal-happy-path --json >"${evidence_root}/fresh-postgresql.json"
run_artisan_postgres "${postgres_fresh_database}" php artisan bpls:lifecycle:run renewal-happy-path >"${evidence_root}/fresh-postgresql-cli.txt"
...
run_artisan_postgres "${postgres_persistent_database}" php artisan db:seed --class=RevenueCodeFeeCatalogSeeder --force --no-interaction >/dev/null
run_artisan_postgres "${postgres_persistent_database}" php artisan bpls:lifecycle:run renewal-happy-path --json >"${evidence_root}/persistent-postgresql-first.json"
run_artisan_postgres "${postgres_persistent_database}" php artisan bpls:lifecycle:run renewal-happy-path --json >"${evidence_root}/persistent-postgresql-rerun.json"
