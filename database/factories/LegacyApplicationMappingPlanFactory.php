...
/**
 * @extends Factory<LegacyApplicationMappingPlan>
 */
class LegacyApplicationMappingPlanFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'run_reference' => 'application-plan-'.fake()->unique()->uuid(),
            'planner_version' => 'bpls.application-mapping-plan.v1',
