    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <main class="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4">
            ...
            >
                ...
                <p class="mt-1">
                    Quarter columns use recorded schedule due dates. Items
                    without a confirmed due date remain listed as unscheduled;
                    this report does not create installment or penalty rules.
                </p>
