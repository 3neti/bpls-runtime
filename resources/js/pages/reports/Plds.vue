    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <main class="flex h-full min-w-0 flex-1 flex-col gap-4 p-4">
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        data-testid="plds-official-row-count"
                    >
                        {{ row_count }}
                    </div>
            ...
            <section
                ...
                data-testid="plds-authority-boundary"
            >
