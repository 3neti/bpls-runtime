    ...
    Route::middleware($stakeholderPreviewMiddleware)->group(function () {
        ...
        Route::middleware(['auth', 'verified', EnsureActiveUserAccess::class])->group(function () {
            Route::middleware(EnsureLifecycleLaboratoryOperator::class)->group(function () {
                ...
                Route::get('stakeholder-preview/lifecycle-laboratory/cleanrooms/{lifecycleCleanroomRun}/office-reviews-assigned/{applicationYear}', [LifecycleCleanroomController::class, 'officeReviewsAssigned'])
                    ->whereNumber('applicationYear')
                    ->name('stakeholder-preview.lifecycle-laboratory.cleanrooms.office-reviews-assigned');
                Route::post('stakeholder-preview/lifecycle-laboratory/cleanrooms/{lifecycleCleanroomRun}/office-reviews-assigned/{applicationYear}/confirm-routine-defaults', [LifecycleCleanroomController::class, 'confirmRoutineOfficeDefaults'])
                    ->whereNumber('applicationYear')
                    ->name('stakeholder-preview.lifecycle-laboratory.cleanrooms.office-reviews-assigned.confirm-routine-defaults');
                ...
                Route::get('stakeholder-preview/lifecycle-laboratory/cleanrooms/{lifecycleCleanroomRun}/evidence', [LifecycleCleanroomController::class, 'showEvidence'])
                    ->name('stakeholder-preview.lifecycle-laboratory.cleanrooms.evidence');
            });
            Route::get('stakeholder-preview/lifecycle-laboratory/cleanrooms/{lifecycleCleanroomRun}/status', [LifecycleCleanroomController::class, 'showStatus'])
                ->name('stakeholder-preview.lifecycle-laboratory.cleanrooms.status');
...
Route::middleware(['auth', 'verified', EnsureActiveUserAccess::class])->group(function () {
    ...
    Route::prefix('staff')->name('staff.')->middleware('can:staff.access')->group(function () {
        ...
        Route::get('reports/collectibles', [CollectiblesReportController::class, 'index'])
        ...
        Route::get('reports/plds', [PldsReportController::class, 'index'])
            ->name('reports.plds.index');
        Route::get('reports/bsp', [BspReportController::class, 'index'])
