...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 49)
            ->where('summary.provisions_requiring_reconciliation', 48)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 280)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 280)
            ->has('revenueCodeProvisions', 49)
            ...
            ->has('revenueCodePolicyBoundaries', 47)
