...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 77)
            ->where('summary.provisions_requiring_reconciliation', 76)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 399)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 399)
            ->has('revenueCodeProvisions', 77)
            ...
            ->has('revenueCodePolicyBoundaries', 75)
