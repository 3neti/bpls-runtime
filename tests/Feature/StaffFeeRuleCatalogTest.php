...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 102)
            ->where('summary.provisions_requiring_reconciliation', 101)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 498)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 498)
            ->has('revenueCodeProvisions', 102)
            ...
            ->has('revenueCodePolicyBoundaries', 100)
