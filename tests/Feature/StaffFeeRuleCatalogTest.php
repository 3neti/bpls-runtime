...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 75)
            ->where('summary.provisions_requiring_reconciliation', 74)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 392)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 392)
            ->has('revenueCodeProvisions', 75)
            ...
            ->has('revenueCodePolicyBoundaries', 73)
            ...
            ->where('revenueCodePolicyBoundaries.37.provision.code', 'MRC-3C-01-SPECIAL-DERBY-FEES')
            ->has('revenueCodePolicyBoundaries.37.clauses', 2)
            ->where('revenueCodePolicyBoundaries.37.clauses.0.amount_cents', 200000)
            ->where('revenueCodePolicyBoundaries.37.clauses.1.amount_cents', 400000)
            ->where('revenueCodePolicyBoundaries.38.provision.code', 'MRC-3C-02-EXCLUSIONS')
            ->has('revenueCodePolicyBoundaries.38.clauses', 2)
            ->where('revenueCodePolicyBoundaries.38.clauses.1.clause_type', 'exemption')
            ->where('revenueCodePolicyBoundaries.39.provision.code', 'MRC-3C-03-PAYMENT-TIMING')
            ->has('revenueCodePolicyBoundaries.39.clauses', 1)
            ->where('revenueCodePolicyBoundaries.39.clauses.0.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.40.provision.code', 'MRC-3C-04-APPLICABILITY')
            ->has('revenueCodePolicyBoundaries.40.clauses', 3)
            ->where('revenueCodePolicyBoundaries.41.provision.code', 'MRC-3D-01-DEFINITIONS')
            ->has('revenueCodePolicyBoundaries.41.clauses', 4)
            ->where('revenueCodePolicyBoundaries.42.provision.code', 'MRC-3D-02-IMPOUNDING-EXPENSES')
            ->has('revenueCodePolicyBoundaries.42.clauses', 1)
            ->where('revenueCodePolicyBoundaries.42.clauses.0.clause_type', 'actual_cost')
            ->where('revenueCodePolicyBoundaries.43.provision.code', 'MRC-3D-03-RELEASE-PAYMENT')
            ->has('revenueCodePolicyBoundaries.43.clauses', 1)
            ->where('revenueCodePolicyBoundaries.44.provision.code', 'MRC-3D-04-CUSTODY-NOTICE')
            ->has('revenueCodePolicyBoundaries.44.clauses', 3)
            ->where('revenueCodePolicyBoundaries.44.clauses.1.clause_type', 'custody_procedure')
            ->where('revenueCodePolicyBoundaries.45.provision.code', 'MRC-3D-04-AUCTION-DISPOSITION')
            ->has('revenueCodePolicyBoundaries.45.clauses', 5)
            ->where('revenueCodePolicyBoundaries.45.clauses.0.clause_type', 'disposition_procedure')
            ->where('revenueCodePolicyBoundaries.46.provision.code', 'MRC-3D-05-PENALTIES-DAMAGES')
            ->has('revenueCodePolicyBoundaries.46.clauses', 4)
            ->where('revenueCodePolicyBoundaries.46.clauses.2.amount_cents', 30000)
            ->where('revenueCodePolicyBoundaries.47.provision.code', 'MRC-3E-01-DAILY-PERMIT-FEE')
            ->has('revenueCodePolicyBoundaries.47.clauses', 1)
            ->where('revenueCodePolicyBoundaries.47.clauses.0.amount_cents', 50000)
            ->where('revenueCodePolicyBoundaries.47.clauses.0.clause_type', 'permit_requirement')
            ->where('revenueCodePolicyBoundaries.48.provision.code', 'MRC-3E-02-PAYMENT-TIMING')
            ->has('revenueCodePolicyBoundaries.48.clauses', 1)
            ->where('revenueCodePolicyBoundaries.48.clauses.0.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.49.provision.code', 'MRC-3E-03-EXEMPTIONS')
            ->has('revenueCodePolicyBoundaries.49.clauses', 3)
            ->where('revenueCodePolicyBoundaries.49.clauses.2.clause_type', 'exemption')
            ->where('revenueCodePolicyBoundaries.50.provision.code', 'MRC-3E-04-ADMINISTRATION')
            ->has('revenueCodePolicyBoundaries.50.clauses', 4)
            ->where('revenueCodePolicyBoundaries.50.clauses.3.clause_type', 'operating_restriction')
            ->where('revenueCodePolicyBoundaries.51.provision.code', 'MRC-3F-01-DEFINITION')
            ->has('revenueCodePolicyBoundaries.51.clauses', 1)
            ->where('revenueCodePolicyBoundaries.51.clauses.0.clause_type', 'definition')
            ->where('revenueCodePolicyBoundaries.52.provision.code', 'MRC-3F-02-FEES')
            ->has('revenueCodePolicyBoundaries.52.clauses', 4)
            ->where('revenueCodePolicyBoundaries.52.clauses.0.amount_cents', 10000)
            ->where('revenueCodePolicyBoundaries.52.clauses.2.amount_cents', 20000)
            ->where('revenueCodePolicyBoundaries.53.provision.code', 'MRC-3F-03-PAYMENT')
            ->has('revenueCodePolicyBoundaries.53.clauses', 1)
            ->where('revenueCodePolicyBoundaries.53.clauses.0.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.54.provision.code', 'MRC-3F-04-REGISTRY')
            ->has('revenueCodePolicyBoundaries.54.clauses', 5)
            ->where('revenueCodePolicyBoundaries.54.clauses.4.clause_type', 'documentary_requirement')
            ->where('revenueCodePolicyBoundaries.55.provision.code', 'MRC-3F-05-APPLICABILITY')
            ->has('revenueCodePolicyBoundaries.55.clauses', 2)
            ->where('revenueCodePolicyBoundaries.55.clauses.0.clause_type', 'authority_boundary')
            ->where('revenueCodePolicyBoundaries.56.provision.code', 'MRC-3G-01-EXCAVATION-FEES')
            ->has('revenueCodePolicyBoundaries.56.clauses', 9)
            ->where('revenueCodePolicyBoundaries.56.clauses.0.amount_cents', 250000)
            ->where('revenueCodePolicyBoundaries.56.clauses.8.clause_type', 'restoration_requirement')
            ->where('revenueCodePolicyBoundaries.57.provision.code', 'MRC-3G-02-PAYMENT-DEPOSIT-FORFEITURE')
            ->has('revenueCodePolicyBoundaries.57.clauses', 3)
            ->where('revenueCodePolicyBoundaries.57.clauses.1.clause_type', 'security_deposit')
            ->where('revenueCodePolicyBoundaries.57.clauses.2.clause_type', 'forfeiture')
            ->where('revenueCodePolicyBoundaries.58.provision.code', 'MRC-3G-03-ADMINISTRATION')
            ->has('revenueCodePolicyBoundaries.58.clauses', 4)
            ->where('revenueCodePolicyBoundaries.58.clauses.3.clause_type', 'operating_restriction')
            ->where('revenueCodePolicyBoundaries.59.provision.code', 'MRC-3H-01-IMPLEMENTING-AGENCY')
            ->has('revenueCodePolicyBoundaries.59.clauses', 1)
            ->where('revenueCodePolicyBoundaries.59.clauses.0.clause_type', 'authority_boundary')
            ->where('revenueCodePolicyBoundaries.60.provision.code', 'MRC-3H-02-SEALING-TESTING')
            ->has('revenueCodePolicyBoundaries.60.clauses', 5)
            ->where('revenueCodePolicyBoundaries.60.clauses.1.clause_type', 'calibration_requirement')
            ->where('revenueCodePolicyBoundaries.61.provision.code', 'MRC-3H-03-FEES')
            ->has('revenueCodePolicyBoundaries.61.clauses', 17)
            ->where('revenueCodePolicyBoundaries.61.clauses.8.amount_cents', 100000)
            ->where('revenueCodePolicyBoundaries.61.clauses.16.amount_cents', 5000)
            ->where('revenueCodePolicyBoundaries.62.provision.code', 'MRC-3H-04-PAYMENT-SURCHARGE')
            ->has('revenueCodePolicyBoundaries.62.clauses', 4)
            ->where('revenueCodePolicyBoundaries.62.clauses.2.clause_type', 'surcharge_interest')
            ->where('revenueCodePolicyBoundaries.63.provision.code', 'MRC-3H-05-PLACE-OF-PAYMENT')
            ->has('revenueCodePolicyBoundaries.63.clauses', 2)
            ->where('revenueCodePolicyBoundaries.63.clauses.1.clause_type', 'situs_definition')
            ->where('revenueCodePolicyBoundaries.64.provision.code', 'MRC-3H-06-EXEMPTIONS')
            ->has('revenueCodePolicyBoundaries.64.clauses', 2)
            ->where('revenueCodePolicyBoundaries.64.clauses.0.clause_type', 'exemption')
            ->where('revenueCodePolicyBoundaries.65.provision.code', 'MRC-3H-07-ADMINISTRATION')
            ->has('revenueCodePolicyBoundaries.65.clauses', 6)
            ->where('revenueCodePolicyBoundaries.65.clauses.5.clause_type', 'disposition_procedure')
            ->where('revenueCodePolicyBoundaries.66.provision.code', 'MRC-3H-08-PROHIBITED-PRACTICES')
            ->has('revenueCodePolicyBoundaries.66.clauses', 14)
            ->where('revenueCodePolicyBoundaries.66.clauses.0.clause_type', 'prohibited_practice')
            ->where('revenueCodePolicyBoundaries.66.clauses.13.clause_type', 'surcharge_interest')
            ->where('revenueCodePolicyBoundaries.67.provision.code', 'MRC-3H-09-PENALTIES')
            ->has('revenueCodePolicyBoundaries.67.clauses', 3)
            ->where('revenueCodePolicyBoundaries.67.clauses.0.clause_type', 'penalty')
            ->where('revenueCodePolicyBoundaries.68.provision.code', 'MRC-3H-10-COMPROMISE')
            ->has('revenueCodePolicyBoundaries.68.clauses', 1)
            ->where('revenueCodePolicyBoundaries.68.clauses.0.clause_type', 'compromise_penalty')
            ->where('revenueCodePolicyBoundaries.69.provision.code', 'MRC-3I-01-CALIBRATION-SEALING')
            ->has('revenueCodePolicyBoundaries.69.clauses', 7)
            ->where('revenueCodePolicyBoundaries.69.clauses.1.clause_type', 'calibration_requirement')
            ->where('revenueCodePolicyBoundaries.70.provision.code', 'MRC-3I-02-UNDERDELIVERY')
            ->has('revenueCodePolicyBoundaries.70.clauses', 6)
            ->where('revenueCodePolicyBoundaries.70.clauses.4.clause_type', 'evidentiary_presumption')
            ->where('revenueCodePolicyBoundaries.71.provision.code', 'MRC-3I-03-SANCTIONS')
            ->has('revenueCodePolicyBoundaries.71.clauses', 3)
            ->where('revenueCodePolicyBoundaries.71.clauses.2.clause_type', 'penalty')
            ->where('revenueCodePolicyBoundaries.72.provision.code', 'MRC-3I-04-FEES')
            ->has('revenueCodePolicyBoundaries.72.clauses', 3)
            ->where('revenueCodePolicyBoundaries.72.clauses.1.amount_cents', 7500)
            ->where('revenueCodePolicyBoundaries.72.clauses.2.amount_cents', 12500)
            ->has('feeRules.data', 4)
