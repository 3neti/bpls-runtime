...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 53)
            ->where('summary.provisions_requiring_reconciliation', 52)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 289)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 289)
            ->has('revenueCodeProvisions', 53)
            ...
            ->has('revenueCodePolicyBoundaries', 51)
