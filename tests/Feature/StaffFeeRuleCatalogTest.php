...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 71)
            ->where('summary.provisions_requiring_reconciliation', 70)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 373)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 373)
            ->has('revenueCodeProvisions', 71)
            ...
            ->has('revenueCodePolicyBoundaries', 69)
