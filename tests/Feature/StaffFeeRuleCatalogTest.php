...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 81)
            ->where('summary.provisions_requiring_reconciliation', 80)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 425)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 425)
            ->has('revenueCodeProvisions', 81)
            ...
            ->has('revenueCodePolicyBoundaries', 79)
