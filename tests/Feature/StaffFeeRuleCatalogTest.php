...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 29)
            ->where('summary.provisions_requiring_reconciliation', 28)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 122)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 122)
            ->has('revenueCodeProvisions', 29)
            ...
            ->has('revenueCodePolicyBoundaries', 25)
