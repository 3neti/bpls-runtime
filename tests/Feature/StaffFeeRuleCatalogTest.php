...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 33)
            ->where('summary.provisions_requiring_reconciliation', 32)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 196)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 196)
            ->has('revenueCodeProvisions', 33)
            ...
            ->has('revenueCodePolicyBoundaries', 31)
