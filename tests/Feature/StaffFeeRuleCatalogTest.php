...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 43)
            ->where('summary.provisions_requiring_reconciliation', 42)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 262)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 262)
            ->has('revenueCodeProvisions', 43)
            ...
            ->has('revenueCodePolicyBoundaries', 41)
