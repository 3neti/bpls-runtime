...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.catalogue_fees', 0)
            ->where('summary.available_fees', 0)
            ->where('summary.incomplete_fees', 0)
            ->where('summary.payment_order_fees', 0)
            ->where('summary.treasury_lob_fees', 0)
            ->where('summary.revenue_code_recorded', 0)
            ->where('summary.revenue_code_missing', 0)
            ->where('technicalSummary.mrc_rules', 4)
            ->where('technicalSummary.blocked_policy_count', 3)
            ->where('technicalSummary.executable_rule_count', 1)
            ->where('technicalSummary.provisions_recorded', 108)
            ->where('technicalSummary.provisions_requiring_reconciliation', 107)
            ->where('technicalSummary.provisions_linked_to_rules', 4)
            ->where('technicalSummary.policy_boundary_clauses', 593)
            ->where('technicalSummary.policy_boundary_clauses_requiring_reconciliation', 593)
            ->has('revenueCodeProvisions', 108)
            ...
            ->has('revenueCodePolicyBoundaries', 106)
            ...
            ->where('revenueCodePolicyBoundaries.73.provision.code', 'MRC-3J-01-FILMING-FEES')
            ->has('revenueCodePolicyBoundaries.73.clauses', 6)
            ->where('revenueCodePolicyBoundaries.73.clauses.0.clause_type', 'permit_requirement')
            ->where('revenueCodePolicyBoundaries.73.clauses.1.amount_cents', 50000)
            ->where('revenueCodePolicyBoundaries.73.clauses.4.amount_cents', 15000)
            ->where('revenueCodePolicyBoundaries.73.clauses.5.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.74.provision.code', 'MRC-3J-02-PAYMENT-TIMING')
            ->has('revenueCodePolicyBoundaries.74.clauses', 1)
            ->where('revenueCodePolicyBoundaries.74.clauses.0.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.75.provision.code', 'MRC-3K-01-ANNUAL-EQUIPMENT-FEES')
            ->has('revenueCodePolicyBoundaries.75.clauses', 23)
            ->where('revenueCodePolicyBoundaries.75.clauses.0.clause_type', 'eligibility')
            ->where('revenueCodePolicyBoundaries.75.clauses.1.amount_cents', 25000)
            ->where('revenueCodePolicyBoundaries.75.clauses.4.amount_cents', 150000)
            ->where('revenueCodePolicyBoundaries.75.clauses.20.amount_cents', null)
            ->where('revenueCodePolicyBoundaries.75.clauses.22.amount_cents', 50000)
            ->where('revenueCodePolicyBoundaries.76.provision.code', 'MRC-3K-02-PAYMENT-TIMING')
            ->has('revenueCodePolicyBoundaries.76.clauses', 1)
            ->where('revenueCodePolicyBoundaries.76.clauses.0.clause_type', 'payment_timing')
            ->where('revenueCodePolicyBoundaries.77.provision.code', 'MRC-3K-03-EQUIPMENT-REGISTRY')
            ->has('revenueCodePolicyBoundaries.77.clauses', 1)
            ->where('revenueCodePolicyBoundaries.77.clauses.0.clause_type', 'documentary_requirement')
            ->where('revenueCodePolicyBoundaries.78.provision.code', 'MRC-3K-04-PENALTY')
            ->has('revenueCodePolicyBoundaries.78.clauses', 1)
            ->where('revenueCodePolicyBoundaries.78.clauses.0.clause_type', 'penalty')
            ->where('revenueCodePolicyBoundaries.79.provision.code', 'MRC-3L-01-SCOPE')
            ->where('revenueCodePolicyBoundaries.80.provision.code', 'MRC-3L-02-DEFINITIONS')
            ->has('revenueCodePolicyBoundaries.80.clauses', 8)
            ->where('revenueCodePolicyBoundaries.82.provision.code', 'MRC-3L-04-GRANTING-MTOP')
            ->where('revenueCodePolicyBoundaries.83.provision.code', 'MRC-3L-05-FEES')
            ->has('revenueCodePolicyBoundaries.83.clauses', 15)
            ->where('revenueCodePolicyBoundaries.83.clauses.0.amount_cents', 62000)
            ->where('revenueCodePolicyBoundaries.88.provision.code', 'MRC-3L-10-DAY-OFF')
            ->where('revenueCodePolicyBoundaries.89.provision.code', 'MRC-3L-11-FARE')
            ->where('revenueCodePolicyBoundaries.94.provision.code', 'MRC-3L-16-PROHIBITED-ACTS')
            ->where('revenueCodePolicyBoundaries.96.provision.code', 'MRC-3L-18-PENALTIES')
            ->has('revenueCodePolicyBoundaries.96.clauses', 3)
            ->where('revenueCodePolicyBoundaries.96.clauses.2.amount_cents', 250000)
            ->where('revenueCodePolicyBoundaries.99.provision.code', 'MRC-3L-21-SEPARABILITY')
            ->where('revenueCodePolicyBoundaries.100.provision.code', 'MRC-3M-01-OCCUPATIONAL-FEES')
            ->has('revenueCodePolicyBoundaries.100.clauses', 70)
            ->where('revenueCodePolicyBoundaries.100.clauses.1.amount_cents', 10000)
            ->where('revenueCodePolicyBoundaries.101.provision.code', 'MRC-3M-02-EXEMPTIONS')
            ->where('revenueCodePolicyBoundaries.102.provision.code', 'MRC-3M-03-PERSONS-GOVERNED')
            ->has('revenueCodePolicyBoundaries.102.clauses', 12)
            ->where('revenueCodePolicyBoundaries.103.provision.code', 'MRC-3M-04-PAYMENT-TIMING')
            ->where('revenueCodePolicyBoundaries.103.clauses.3.amount_cents', 2500)
            ->where('revenueCodePolicyBoundaries.104.provision.code', 'MRC-3M-05-LATE-CHANGES-RENEWAL')
            ->where('revenueCodePolicyBoundaries.105.provision.code', 'MRC-3M-06-ADMINISTRATION')
            ->has('feeRules.data', 4)
