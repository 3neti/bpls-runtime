...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 61)
            ->where('summary.provisions_requiring_reconciliation', 60)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 318)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 318)
            ->has('revenueCodeProvisions', 61)
            ...
            ->has('revenueCodePolicyBoundaries', 59)
