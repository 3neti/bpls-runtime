...
it('shows the read-only taxes and fees catalog to authorized staff', function () {
    ...
    $this->actingAs($user)
        ...
        ->assertInertia(fn (Assert $page) => $page
            ...
            ->where('summary.provisions_recorded', 58)
            ->where('summary.provisions_requiring_reconciliation', 57)
            ->where('summary.provisions_linked_to_rules', 4)
            ->where('summary.policy_boundary_clauses', 302)
            ->where('summary.policy_boundary_clauses_requiring_reconciliation', 302)
            ->has('revenueCodeProvisions', 58)
            ...
            ->has('revenueCodePolicyBoundaries', 56)
