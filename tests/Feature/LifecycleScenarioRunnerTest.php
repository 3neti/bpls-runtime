...
test('revenue code fee catalog visibility scenario prepares deterministic catalog evidence idempotently', function () {
    ...
    expect($firstManifest['scenario']['key'])->toBe('revenue_code_fee_catalog_visibility')
        ...
        ->and($firstManifest['resources']['provision_count'])->toBe(75)
        ->and($firstManifest['resources']['reconciliation_required_count'])->toBe(74)
        ...
        ->and($firstManifest['resources']['policy_boundary_summary'])->toBe([
            'provision_count' => 73,
            'clause_count' => 392,
            'reconciliation_required_count' => 392,
            'ceiling_count' => 5,
            'execution_ready_count' => 0,
        ])
        ->and($firstManifest['resources']['policy_boundary_clause_codes'])->toHaveCount(392)
