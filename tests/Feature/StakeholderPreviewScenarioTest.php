...
test('preview preparation creates synthetic role accounts and policy-bound evidence without storing credentials', function () {
    ...
    expect($accounts)->toHaveCount(14)
        ...
        ->and($accounts['stakeholder.preview.citizen@example.test']->primaryRole()?->code)->toBe('preview_citizen')
        ->and($accounts['stakeholder.preview.bplo@example.test']->primaryRole()?->code)->toBe('preview_bplo')
        ->and($accounts['stakeholder.preview.assessment-officer@example.test']->primaryRole()?->code)->toBe('preview_assessment_officer')
        ->and($accounts['stakeholder.preview.treasury@example.test']->primaryRole()?->code)->toBe('preview_treasury')
        ->and($accounts['stakeholder.preview.municipal-treasurer@example.test']->primaryRole()?->code)->toBe('preview_municipal_treasurer')
        ...
        ->and($accounts['stakeholder.preview.cashier@example.test']->primaryRole()?->code)->toBe('preview_cashier')
        ->and($accounts['stakeholder.preview.management@example.test']->primaryRole()?->code)->toBe('preview_management')
